...
hexo help
```
![hexoH](/CSBLOG/images/hexoH.jpg)
##### ->本地静态生成并测试自己的博客
```bash
hexo s -g
```
![hexoD](/CSBLOG/images/hexoD.jpg)
最后通过终端输出提示的地址进入浏览器预览自己的本地博客，下图显示的是我自己已经修改过内容的网站，如果是初始状态的话，应该是有“Hexo”字眼的首页。
![blogL](/CSBLOG/images/BlogL.jpg)
##### ->通过GitHub部署自己的博客
...
url: https://xiaobinligit.github.io/CSBLOG/
root: /CSBLOG/
...
hexo new test
```
![blognew](/CSBLOG/images/Blognew.jpg)
通过编辑器配置md文件，如下为例：
```
---
title: 重启博客
